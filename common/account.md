...
6. Выбрать русский язык в eSender
    - Нажать на правый нижний пункт меню [1], выбрать первый пункт в открывшемся списке [2] <img class=app-screenshot src='account-esender-1-05.png' alt='Смена языка в eSender в WeChat'>
