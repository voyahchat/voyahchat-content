Настройка приложений в машине с чипом NXP (дорест33 до 2023) для удобной эксплуатации. Этот же список используется для [платной установки/настройки](software_setup.md).
...
Устанавить [Яндекс Музыку NXP](software_yandex-music-nxp.md).
