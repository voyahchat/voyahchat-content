...
* [`Переопределить кнопку музыки в навбаре`]](tweaks_settings.md#7-выбор-приложения-музыки), выбрать `Yandex Music`
...
* Должна быть [переопределена кнопка навигации](tweaks_settings.md#6-выбор-приложения-навигации)
