Настройка приложений в машине для удобной эксплуатации. Этот же список используется для [платной установки/настройки](software_setup.md).
...
Установить [AutoKit](software_autokit.md), если вам нужен CarPlay.
...
- В настройках включить тёмную тему (если у вас тёмная тема интерфейса машины), выключить все Яндекс Станции и выключить уведомления о новинках
- Запустить My vibe
