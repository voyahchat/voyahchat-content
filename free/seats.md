...
Так же этот диалог появляется при настройках водительского сидения кнопками слева снизу на сиденье.
...
Если машину используют два водителя возможны такие варианты подстройки сидений:
...
3. На машинах ОД РФ можно менять водителя в верхней шторке
4. [Установить VoyahTweaks](../common/tweaks.md) и через него восстанавливать положение сидений или на вкладке [Комфорт](../common/tweaks_settings.md#1-настройки-положений-сиденийзеркал), или [голосовой командой](../common/tweaks_settings.md#голосовой-помощник)
